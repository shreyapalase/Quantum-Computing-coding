...
- The Theory behind Deautsch-Jozsa Algorithm.
- How to implement Deautsch-Jozsa Algorithm using  **Qiskit AerSimulator**
- How to 3-bit input.
- implemetation of function Constant and Balanced.

...
*   The probability of measuring the state $|0\rangle$ is given by the squared magnitude of its amplitude: $$ P(0) = |\alpha|^2 $$
*   The probability of measuring the state $|1\rangle$ is given by the squared magnitude of its amplitude: $$ P(1) = |\beta|^2  $$
*   Since the qubit must collapse to one of these two states, the probabilities must sum to 1: $$  P(0) + P(1) = |\alpha|^2 + |\beta|^2 = 1 $$  
